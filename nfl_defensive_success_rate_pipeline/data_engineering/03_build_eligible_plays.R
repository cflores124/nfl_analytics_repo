...
#
# Eligible play:
#   Pass or run, including sacks, excluding nullified/no-play
#   events, kneels, spikes, special-teams plays, and two-point
#   attempts.
#
# Nullified/no-play events are excluded because only rows with
# play_type equal to "pass" or "run" are retained.
#
# Inputs:
